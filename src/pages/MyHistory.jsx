				...
				<div className='section purple lighten-5'>
					<div className='row container'>
						...
						<img
							...
							src={Lotus}
							onClick={() => swal({ icon: `${Lotus}`, text: 'Cette peinture a été réalisée par mes soins .' })}
						/>
						<p className='grey-text text-darken-3 lighten-3' style={{ fontFamily: 'Snell Roundhand, Bookman Old Style', fontSize: '40px' }}>
							...
							aussi , avait perdu un être cher . Bercée depuis son enfance dans le domaine spirituel , j'ai pu l'aider et elle a su en retour , me faire
							accepter ce que mes guides spirituels me demandaient . Tout simplement , d'aider mon prochain .
						</p>
						<p className='grey-text text-darken-3 lighten-3' style={{ fontFamily: 'Snell Roundhand, Bookman Old Style', fontSize: '40px' }}>
