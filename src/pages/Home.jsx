			...
			<div>
				...
				<div className='section purple lighten-5'>
					<div className='row container'>
						...
						<p className='grey-text text-darken-3 lighten-3' style={{ fontFamily: 'Snell Roundhand, Dancing Script', fontSize: '40px' }}>
						...
						<p className='grey-text text-darken-3 lighten-3' style={{ fontFamily: 'Snell Roundhand, Dancing Script', fontSize: '40px' }}>
							<b>L</b>ors de notre discussion , je recevrai des flashs , des paroles , des sensations que je ressentirai et que je
							partagerai aussitôt avec vous , sous la surveillance bienveillante de mes guides spirituels . J'établirai un contact auquel vous participerez
							oralement , pour vous donner la paix et le pardon réciproquement , ce qui lèvera les problèmes , les blocages dans le dialogue tout en ne
							négligeant pas de les lever sur les générations passées mais aussi présentes et futures ainsi que sur les vies antérieures qui entrent en ligne
							de compte et qui expliquent souvent , les problèmes et les blocages .
						</p>
						<p className='grey-text text-darken-3 lighten-3' style={{ fontFamily: 'Snell Roundhand, Dancing Script', fontSize: '40px' }}>
							<b>L</b>e mal-être provoqué par ces derniers sont d'ordre variés que nous ne
							soupçonnons même pas . Cela m'étonne encore à chaque fois , d'une manière ou d'une autre , car le secret des ÂMES nous dévoile " ce qu'il faut et
							pas plus au bon moment . " Cela vous permettra de faire le point sur ce que vous voulez au plus profond de votre âme et ce que vous êtes
							vraiment .
						</p>
						<p className='grey-text text-darken-3 lighten-3' style={{ fontFamily: 'Snell Roundhand, Dancing Script', fontSize: '40px' }}>
							<b>D</b>ans beaucoup de cas , un petit travail personnel sera nécessaire à celui que nous effectuerons ensemble . Il vous permettra de
							sceller , ce que les êtres de lumière nous ont aidé à faire et de pouvoir méditer dessus le temps d'un instant .
						</p>
						<p className='grey-text text-darken-3 lighten-3' style={{ fontFamily: 'Snell Roundhand, Dancing Script', fontSize: '40px' }}>
							<b>C</b>haque fois , la demande me sera
							dictée par eux-mêmes , sera précisément adaptée à la situation et se présentera sous formes de prières personnalisées selon le cas exposé .
						</p>
						<br />
						<Row>
							<Col s={1}></Col>
